...
from builders.data_training_builders import (
    section_data_array, create_labels, add_labels, add_data_arrays_to_time_and_frequency_data_lists)
...
def generate_array_of_other_activities(data_array_acc, data_array_gyr, array_size, acc_data_array_list, gyr_data_array_list,
    ...
    for i in range(parts):
        ...
        if generate_labels == "yes":
            add_labels(multiple_class_label_1, multiple_class_label_2,
                       binary_class_label_1, binary_class_label_2, labels_list)
        ...
        if activity in five_second_activity_list:
            ...
            generate_array_of_other_activities(magacc, maggyr, array_size, list_of_data_arrays_in_the_time_domain[0],
                                               list_of_data_arrays_in_the_time_domain[
                                                   4], list_of_data_arrays_in_the_frequency_domain[0],
                                               list_of_data_arrays_in_the_frequency_domain[
                                                   4], multiple_class_label_1,
            ...
            generate_array_of_other_activities(zacc, zgyr, array_size, list_of_data_arrays_in_the_time_domain[3],
                                               ...
                                               multiple_class_label_1,
                                               multiple_class_label_2,
                                               binary_class_label_1,
                                               binary_class_label_2,
                                               labels_list)
